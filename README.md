...
You can view the development server at [http://localhost:4005](http://localhost:4005).
...
2. Open [http://localhost:4005/src/html/workbench.html](http://localhost:4005/src/html/workbench.html) in your browser.
